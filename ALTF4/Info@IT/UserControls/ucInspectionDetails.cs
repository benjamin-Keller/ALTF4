...
namespace Info_IT.UserControls
{
	public partial class ucInspectionDetails : UserControl
	{
		...
		private void BtnManageUpdate_Click(object sender, EventArgs e)
		{
            ...
            {
                //Error for input string not found
                DAL.InspectionDetailClass inspection = new DAL.InspectionDetailClass(DAL.InspectionDetailClass.InspectionDetailCode, int.Parse(cmbInspectionCode.SelectedValue.ToString()), int.Parse(cmbEquipmentCode.SelectedValue.ToString()), int.Parse(cmbStaffCode.SelectedValue.ToString()), txtFaultComment.Text, cmbStatus.SelectedText.ToString());
        ...
        private void dgvinspectionDetails_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbStatus.SelectedValue = values.Rows[0].Table.Rows[0].ItemArray[5];
        }
    }
}